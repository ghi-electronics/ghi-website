...
<div className="section-tinted__intro">
  <span className="eyebrow">Case Study · Fleet Diagnostics</span>
...
![PACCAR truck fleet](/img/case-studies/fleet-diagnostics-trucks.jpg)
...
<img src="/img/case-studies/fleet-diagnostics-paccar.gif" alt="PACCAR logo" style={{maxWidth: '280px', display: 'block', margin: '1.5rem 0'}} />
...
![PACLink wireless diagnostic tool](/img/case-studies/fleet-diagnostics-paclink.jpg)
