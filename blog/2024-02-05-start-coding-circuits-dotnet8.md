---
title: Start Coding Circuits with .NET 8 Today
tags: [endpoint, announcement]
image: /img/press/endpoint-dotnet8.jpg
---

![Endpoint Domino — .NET 8 on hardware](/img/press/endpoint-dotnet8.jpg)

Endpoint Domino is now available, bringing the full .NET 8 framework to embedded hardware. CAN, analog, NeoPixel, and signal processing libraries extend what's already in the .NET ecosystem — deploy and debug remotely from Visual Studio or VS Code over USB.
