...
:::tip
This NuGet also includes the standard, .NET-compatible **`System.IO.Ports`** API — see **[GHIElectronics.TinyCLR.System.IO.Ports](../GHIElectronics.TinyCLR.System.IO.Ports/index.md)**.
:::
