...
:::info
The standard, .NET-compatible `System.Device.Gpio` API for TinyCLR. It ships inside the **[GHIElectronics.TinyCLR.Devices.Gpio](../Devices.Gpio/index.md)** NuGet — there is no separate package to install.
:::
