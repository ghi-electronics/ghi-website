...
:::tip
This NuGet also includes the standard, .NET-compatible **`System.Device.Gpio`** API — see **[GHIElectronics.TinyCLR.System.Device.Gpio](../GHIElectronics.TinyCLR.System.Device.Gpio/index.md)**.
:::
