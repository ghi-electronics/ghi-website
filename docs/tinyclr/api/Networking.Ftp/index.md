...
<h1 className="api-package-heading">Networking.Ftp Library</h1>

## Classes

| Class | Namespace | Summary |
|---|---|---|
| [Ftp](./Ftp.md) | `System.Net` |  |
| [Ftp](./Ftp_2.md) | `GHIElectronics.TinyCLR.Networking` |  |
| [FTPCommand](./FTPCommand.md) | `System.Net` | Ftp command class |
| [FtpDefaultListener](./FtpDefaultListener.md) | `GHIElectronics.TinyCLR.Networking.Ftp` |  |
| [FtpFilesystemListener](./FtpFilesystemListener.md) | `GHIElectronics.TinyCLR.Networking.Ftp` |  |
...
| [FtpMemoryListener](./FtpMemoryListener.md) | `GHIElectronics.TinyCLR.Networking.Ftp` |  |
...
| [UserAuthenticatorArgs](./UserAuthenticatorArgs.md) | `GHIElectronics.TinyCLR.Networking` |  |
| [UserInfo](./UserInfo.md) | `GHIElectronics.TinyCLR.Networking.Ftp` | User information containing username and password |
| [WebRequestMethods](./WebRequestMethods.md) | `System.Net` |  |
| [WebRequestMethodsEx](./WebRequestMethodsEx.md) | `GHIElectronics.TinyCLR.Networking` |  |

## Enums

| Enum | Namespace | Summary |
|---|---|---|
| [FtpStatusCode](./FtpStatusCode.md) | `System.Net` |  |
...
|---|---|---|
| [UserAuthenticator](./UserAuthenticator.md) | `GHIElectronics.TinyCLR.Networking` |  |
