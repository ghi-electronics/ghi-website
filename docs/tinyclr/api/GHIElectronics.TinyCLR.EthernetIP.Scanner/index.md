...
|---|---|---|
| [AssemblyObject](./AssemblyObject.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
| [CIPException](./CIPException.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
| [CIPIdentityItem](./CIPIdentityItem.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` | Table 2-4.4 CIP Identity Item |
| [CommonPacketFormat](./CommonPacketFormat.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
...
| [Encapsulation](./Encapsulation.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
...
| [MessageRouterObject](./MessageRouterObject.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
...
| [TcpIpInterfaceObject](./TcpIpInterfaceObject.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
| [UdpState](./UdpState.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |

## Structs

| Struct | Namespace | Summary |
|---|---|---|
| [ClassAttributesStruct](./ClassAttributesStruct.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
| [InstanceAttributesStruct](./InstanceAttributesStruct.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
...
| [ObjectListStruct](./ObjectListStruct.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
| [PhysicalLink](./PhysicalLink.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` | Page 5.5 Volume 2 |
| [Revison](./Revison.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
...
| [ConnectionType](./ConnectionType.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
| [Priority](./Priority.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
| [RealTimeFormat](./RealTimeFormat.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
| [StateEnum](./StateEnum.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner.ObjectLibrary` |  |
...
|---|---|---|
| [EipEventHandler](./EipEventHandler.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
| [ImplicitDataReceivedHandler](./ImplicitDataReceivedHandler.md) | `GHIElectronics.TinyCLR.EthernetIP.Scanner` |  |
