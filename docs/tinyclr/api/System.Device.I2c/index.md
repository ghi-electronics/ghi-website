...
<h1 className="api-package-heading">System.Device.I2c Library</h1>

:::info
The standard, .NET-compatible `System.Device.I2c` API for TinyCLR. It ships inside the **[GHIElectronics.TinyCLR.Devices.I2c](../Devices.I2c/index.md)** NuGet — there is no separate package to install.
:::
