...
![Development Options](https://docs.ghielectronics.com/hardware/sitcore/images/sitcore-dev-boards.png)
...
![Development Options](https://docs.ghielectronics.com/hardware/sitcore/images/sc13048q.png)
...
To start development using the SC13048Q Dev Board, just connect the board's USB Client port to a host computer using a USB-C cable. Go to the [Getting Started](/docs/tinyclr/) page in the TinyCLR section of the documentation page for further instructions.
...
[SC13048Q Dev Board Schematic](https://docs.ghielectronics.com/hardware/sitcore/pdfs/sc13048q-dev-rev-b-schematic.pdf)
...
![Development Options](https://docs.ghielectronics.com/hardware/sitcore/images/sc20100s.png)
...
To start development using the SC20100S Dev Board, just connect the board's USB Client port to a host computer using a USB-C cable. Go to the [Getting Started](/docs/tinyclr/) page in the TinyCLR section of the documentation page for further instructions.
...
[SC20100S Dev Board Schematic](https://docs.ghielectronics.com/hardware/sitcore/pdfs/sc20100s-dev-rev-c-schematic.pdf)
...
![Development Options](https://docs.ghielectronics.com/hardware/sitcore/images/scm20260d.png)
...
To start development using the SCM20260D Dev Board, just install the module on the board, plug in the display (if needed), and connect the board's USB Client port to a host computer using a USB-C cable. Go to the [Getting Started](/docs/tinyclr/) page in the TinyCLR section of the documentation page for further instructions.

The board can be powered through either the USB client connectors or the barrel jack. Always use the barrel jack for power when using displays, especially the larger ones. USB does not provide sufficient power needed for displays.

[SCM20260D Dev Board Schematic](https://docs.ghielectronics.com/hardware/sitcore/pdfs/scm20260d-dev-rev-c-schematic.pdf)
...
![UD435](https://docs.ghielectronics.com/hardware/sitcore/images/ud435.png)
...
[4.3" Display Module Schematic](https://docs.ghielectronics.com/hardware/sitcore/pdfs/ud435-rev-b-schematic.pdf)
...
The [TinyCLR Samples repo](https://github.com/ghi-electronics/TinyCLR-Samples) has usage examples. You can learn more in the [Graphics](/docs/tinyclr/feature/graphics) and [Display](/docs/tinyclr/feature/displays) sections of the TinyCLR tutorials.
...
![UD700](https://docs.ghielectronics.com/hardware/sitcore/images/ud700.png)
...
[7" Display Module Schematic](https://docs.ghielectronics.com/hardware/sitcore/pdfs/ud435-rev-b-schematic.pdf)
...
![hdmi](https://docs.ghielectronics.com/hardware/sitcore/images/sitcore-hdmi.png)
...
[SITCore HDMI Adaptor Schematic](https://docs.ghielectronics.com/hardware/sitcore/pdfs/scd-hdmi-a-schematic.pdf)
...
![OV9655 Breakout](https://docs.ghielectronics.com/hardware/sitcore/images/ov9655-breakout.png)
...
![Good camera](https://docs.ghielectronics.com/hardware/sitcore/images/good-camera.jpg).

The bad modules have voltage regulators labeled "2EB2S" and "3AB2I:"

![Bad camera](https://docs.ghielectronics.com/hardware/sitcore/images/bad-camera.jpg)
