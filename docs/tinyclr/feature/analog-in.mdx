...
:::note
Unlike GPIO, SPI, I²C, and PWM, ADC isn't part of the Microsoft .NET IoT standard device APIs. TinyCLR's ADC is the `GHIElectronics.TinyCLR.Devices.Adc` namespace, in the NuGet package of the same name.
:::

NuGet packages:

- **`GHIElectronics.TinyCLR.Devices.Adc`** — the `GHIElectronics.TinyCLR.Devices.Adc` namespace.
