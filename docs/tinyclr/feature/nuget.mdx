...
![View Show Solution Explorer](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/select-manage-nuget-packages.gif)

3. Make sure the package source is set to "Package source" or "All."

![Set package source](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/package-source.png)

4. In the search box type "tinyclr." **You may have to check the "Include prerelease" box to find the libraries.**
![Search for TinyCLR](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/search-for-tinyclr.png)
5. Selecting the `Browse` tab will show all the TinyCLR NuGet packages.
![Browse NuGet Feed](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/browse-nuget-feed.png)

6. To install one of the packages click on the down arrow to the right of the package version.
![Add Nuget Package](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/add-nuget-package.png)

You can also select the package and click on the `Install` button in the center panel.
![Nuget-package-install-button](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/nuget-install-button.png)

7. Click `OK` to accept the proposed changes.

![Accept changes](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/accept-changes.png)

8. Accept the licensing agreement to install the package.

![Accept Agreement for NuGet](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/accept-agreement-for-nuget.png)
