...
:::warning
**This feature is experimental** and the API is subject to major changes or removal. Don't ship production firmware that depends on it without confirming the API surface against the current release.
:::
