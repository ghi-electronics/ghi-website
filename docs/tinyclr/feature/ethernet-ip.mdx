...
|---|---|
| [GHIElectronics.TinyCLR.EthernetIP.Scanner](/docs/tinyclr/api/EthernetIP.Scanner/) | EtherNet/IP scanner (master) classes |
| [GHIElectronics.TinyCLR.EthernetIP.Adapter](/docs/tinyclr/api/EthernetIP.Adapter/) | EtherNet/IP adapter (slave) classes |
