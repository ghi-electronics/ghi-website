...
These protocols facilitate communication between the SITCore device and a PC. The [USB Client](usb-client.mdx) page has more details and is a prerequisite to this tutorial.
...
![WebUSB Select](/img/docs/webusb-select.jpg)

On successful connection the input drop downs are enabled. 

![WebUSB Select](/img/docs/webusb-pin-select.jpg)
...
![WebUSB LED](/img/docs/webusb-dev.jpg)
