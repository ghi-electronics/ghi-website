...
![Importing Root Certificate Step 1](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-server1.png)

2. Make sure `Current User` is selected.

![Importing Root Certificate Step 2](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-server2.png)

3. Select `Place all certificates in the following store`. Click `Browse...` and select `Trusted Root Certification Authorities`

![Importing Root Certificate Step 3](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-server3.png)

From this moment your PC will trust all Certificates signed from your CA

![Importing Root Certificate Step 4](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-server4.png)
...
![Removing a Root Certificate Step 1](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-server5.png)
...
![Removing a Root Certificate Step 2](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-server6.png)
