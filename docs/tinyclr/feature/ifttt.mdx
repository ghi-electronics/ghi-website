...
![IFTTT Start Connecting](/img/docs/ifttt-start-connecting.png)
...
![IFTTT Create Your Own](/img/docs/ifttt-create-your-own.png)
...
![IFTTT Choose action service](/img/docs/ifttt-choose-action-service.png)
...
![IFTTT Send me an email](/img/docs/ifttt-send-me-an-email.png)
...
![IFTTT Complete action fields](/img/docs/ifttt-complete-action.png)

This will then take you back to the main If Then page. Click on continue

![IFTTT Continue](/img/docs/ifttt-continue.png)
...
![IFTTT Click Webhooks icon](/img/docs/ifttt-click-webhooks-icon.png)
...
![IFTTT Webhooks Key](/img/docs/ifttt-webhooks-key.png)
...
![Temperature sensor circuit](/img/docs/sensor-circuit.png)
