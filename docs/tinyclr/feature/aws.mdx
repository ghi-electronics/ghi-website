...
![AWS Management Console](/img/docs/aws-select-iot.jpg)
...
![AWS Create Policy](/img/docs/aws-create-policy.jpg)
...
![AWS Manage Things](/img/docs/aws-manage-things.jpg)

Next, we click on 'Create a single thing'

![AWS Create Single Thing](/img/docs/aws-create-single.jpg)
...
![AWS Create DeviceID](/img/docs/aws-name-device.jpg)
...
![AWS Create Certificates](/img/docs/aws-create-certificates.jpg)
...
![AWS Copy Endpoint](/img/docs/aws-copy-endpoint.jpg)
...
![AWS Device Activity](/img/docs/aws-device-activity.jpg)
...
![AWS Device Activity](/img/docs/aws-message-recieved.jpg)
