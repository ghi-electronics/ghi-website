...
:::tip
If you're using VS Code, the TinyCLR template allows for adding resources to your project — see the [Getting Started VS Code tutorial](../tutorial/vscode.mdx#step-2--add-a-resource).
:::
