...
![CAN linear bus](https://docs.ghielectronics.com/software/tinyclr/images/can-bus.png)
...
![CAN bit segments](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/can-bit-segments.png)
