...
var settings = new I2cConnectionSettings(FEZBit.I2cBus.Chip0, 0x1D);
...
var controller = I2cController.FromName(FEZBit.I2cBus.Chip0);
...
|---|---|
| [GHIElectronics.TinyCLR.Devices.I2c](/docs/tinyclr/api/GHIElectronics.TinyCLR.Devices.I2c/) | TinyCLR IÂ²C controller and device classes |
