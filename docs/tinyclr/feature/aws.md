...
![AWS Management Console](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-select-iot.jpg)
...
![AWS Create Policy](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-create-policy.jpg)
...
![AWS Manage Things](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-manage-things.jpg)

Next, we click on 'Create a single thing'

![AWS Create Single Thing](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-create-single.jpg)
...
![AWS Create DeviceID](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-name-device.jpg)
...
![AWS Create Certificates](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-create-certificates.jpg)
...
![AWS Download Certs](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-download-cert.jpg)

Check the box for the 'Policy' we created earlier, and then click the 'Register Thing' button.

![AWS Add Policy](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-add-policy.jpg)


Add the 3 Certificates we downloaded to Resources in our project and SAVE your project.

![AWS Certs Resources](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-cert.jpg)

Inside the 'Things' registry list click on the device you just created.

![AWS Select Device](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-select-device.jpg)
...
![AWS Copy Endpoint](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-copy-endpoint.jpg)
...
![AWS Device Activity](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-device-activity.jpg)
...
![AWS Device Activity](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/aws-message-recieved.jpg)
