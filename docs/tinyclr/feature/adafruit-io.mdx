...
![Adafruit IO Add Certificate](/img/docs/adaIO-add-cert.jpg)
...
![Adafruit create Dashboard](/img/docs/adaIO-create-dashboard.jpg)

Create a meaningful name for our Dashboard. This will be the 'dashboardID' inside our code sample. 

![Adafruit name Dashboard](/img/docs/adaIO-name-dashboard.jpg)

Click on our newly created 'Dashboard'

![Adafruit select Dashboard](/img/docs/adaIO-select-dashboard.jpg)
...
![Adafruit create Block](/img/docs/adaIO-create-block.jpg)
...
![Adafruit select Toggle](/img/docs/adaIO-select-toggle.jpg)
...
![Adafruit name feed](/img/docs/adaIO-name-feed.jpg)

Check the box of the newly created feed and click 'Next Step'

![Adafruit name feed](/img/docs/adaIO-next-step.jpg)
...
![Adafruit block settings](/img/docs/adaIO-block-settings.jpg)
...
![Adafruit create another Blcok](/img/docs/adaIO-add-newblock.jpg)

Let's add a 'Gauge' block to our canvas next. 

![Adafruit create another Blcok](/img/docs/adaIO-add-gauge.jpg)
...
![Adafruit name gauge feed](/img/docs/adaIO-name-gaugefeed.jpg)

There are several setting we can adjust but for this tutorial we'll just us the default and click on 'Create block'

![Adafruit name gauge feed](/img/docs/adaIO-create-gaugeblock.jpg)
...
![Adafruit select key](/img/docs/adaIO-select-key.jpg)

Copy the generated key...

![Adafruit generate key](/img/docs/adaIO-generate-key.jpg)
...
![Adafruit running dashboard](/img/docs/adaIO-complete-dashboard.jpg)

![Adafruit running dashboard](/img/docs/adaIO-message-vs.jpg)
