...
First download the required Adafruit Root Certificate and add to resources. The [TLS Client](tls-client.mdx) shows how to download the root certificate.
