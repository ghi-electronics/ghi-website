...
|---|---|
| [GHIElectronics.TinyCLR.Networking](/docs/tinyclr/api/Networking/) | Socket, DNS, and mDNS networking classes |
| [GHIElectronics.TinyCLR.Devices.Network](/docs/tinyclr/api/Devices.Network/) | Network interface controller (MAC address, IP config) |
