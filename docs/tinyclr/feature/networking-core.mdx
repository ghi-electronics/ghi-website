...
|---|---|
| [GHIElectronics.TinyCLR.Networking](/docs/tinyclr/api/GHIElectronics.TinyCLR.Networking/) | Socket, DNS, and mDNS networking classes |
| [GHIElectronics.TinyCLR.Devices.Network](/docs/tinyclr/api/GHIElectronics.TinyCLR.Devices.Network/) | Network interface controller (MAC address, IP config) |
