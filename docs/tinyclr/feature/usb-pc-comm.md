...
![WebUSB Connect](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/webusb-connect.jpg)

User will see `TinyCLR WebUsb` device as an option to `Connect`

![WebUSB Select](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/webusb-select.jpg)

On successful connection the input drop downs are enabled. 

![WebUSB Select](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/webusb-pin-select.jpg)

After selecting `Update State` the device sends back a message indicating the outcome. 

![WebUSB Success](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/webusb-success.jpg)

In this case the `PB0` is set `HIGH` and the LED turns on.

![WebUSB LED](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/webusb-dev.jpg)
