...
![GCloud Create Project](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-create-project.jpg)

Next we'll need to create a meaningful name, for this project will call it SITCoreIoT. 

![GCloud Name Project](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-name-project.jpg)

In the search box type 'IoT Core' and then select it. 

![GCloud Search IoT Core](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-search-iotcore.jpg)

Next, we need to 'ENABLE' the Google Cloud IoT API. 

![GCloud Enable API](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-enable-cloud.jpg)

Next we'll need to create a Registry for our project. Click on 'CREATE REGISTRY'

![GCloud Create Registry](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-create-registry.jpg)
...
![GCloud Name Registry](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-registry-id.jpg)
...
![GCloud Set Protocols](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-set-protocol.jpg)
...
![GCloud Create Device](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-create-device.jpg)

From the Device dashboard, click on 'CREATE A DEVICE' 

![GCloud Create Device](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-device-create.jpg)
...
![GCloud RSA Key](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-generate-keys.jpg)
...
![GCloud Create Device ID](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-set-deviceID.jpg)
...
![GCloud Paste Public Key](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-paste-key.jpg)

Next we'll create a Gateway. From inside the Device details dashboard select 'Gateways' from the menu on the left.

![GCloud Select Gateway](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-select-gateway.jpg)

Click on the 'CREATE A GATEWAY'

![GCloud Create Gateway](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-create-gateway.jpg)
...
![GCloud Name Gateway](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-name-gateway.jpg)
...
![GCloud Gateway RSA](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-gateway-RSA.jpg)
...
![GCloud Bind Device](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-bind-device.jpg)
...
![How to download generate JWT](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/generate_jwt.png)
...
![GCloud Message in VS](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-send-command.jpg)

Enter your message and click 'SEND'

![GCloud Create Message](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-create-message.jpg)

The device will receive your message and display it in the Output window of Visual Studio. 

![GCloud Message in VS](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-message-vs.jpg)
...
![GCloud Send Message to Cloud](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-select-topic.jpg)

Once on the 'Pub/Sub' dashboard, select 'Subscriptions' from the side menu.

![GCloud Select Subscriptions](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-select-subscription.jpg)

Next, click on 'CREATE SUBSCRIPTION'

![GCloud Create Subscription](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-create-subscription.jpg)
...
![GCloud Name Subscription](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-name-subscription.jpg)
...
Deploy the program to your device. Once connected, inside the 'Subscription details' dashboard, click on 'VIEW MESSAGES', inside the 'Messages' Pop-up click on the 'PULL' button. This will display the latest messages being sent from the device. The tutorial program sends a new message every 5 seconds and then increments the count by one. We can also continue to send messages to the device from the 'Gateway' dashboard as we did earlier. 
 ...
 ![GCloud View Messages](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/gcloud-view-messages.jpg)