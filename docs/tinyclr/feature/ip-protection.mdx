...
Designed with security as a top priority, TinyCLR provides protection for both user's code and user's data.
...
The [In-Field Update](in-field-update.mdx) page covers the details on updating a locked system.
...
Refer to the [External Memory](external-memory.mdx) page for more info.
