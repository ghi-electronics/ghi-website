...
Any Cellular modem with PPP support should simply work with TinyCLR OS. Please see our [PPP tutorial](ppp.mdx) for more details and sample code. Other networking information and sample code can be found on our [WiFi](wifi.mdx) and [Ethernet](ethernet.mdx) tutorials.
