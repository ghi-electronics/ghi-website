...
:::tip
Want a guided start instead of reference material? The [Create Graphics tutorial](../tutorial/create-graphics.mdx) walks through this exact display setup and draws on it, and [Build a Touch UI](../tutorial/touch-ui.mdx) builds a two-page touch app on top of the same configuration.
:::
