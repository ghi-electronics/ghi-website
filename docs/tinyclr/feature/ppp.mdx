...
|---|---|
| [GHIElectronics.TinyCLR.Devices.Network](/docs/tinyclr/api/GHIElectronics.TinyCLR.Devices.Network/) | Network interface controller (PPP configuration) |
| [GHIElectronics.TinyCLR.Devices.Uart](/docs/tinyclr/api/GHIElectronics.TinyCLR.Devices.Uart/) | UART controller (underlying PPP transport) |
