...
`BasicGraphics` driver is a simpler alternative that runs on all devices, including small devices without native display support. Learn more about `BasicGraphics` [here.](https://docs.ghielectronics.com/software/tinyclr/drivers/software-utility.html)
