...
![IFTTT Start Connecting](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-start-connecting.png)
...
![IFTTT Create Your Own](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-create-your-own.png)
...
![IFTTT If This Then That](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-if-this.png)

Search for `webhooks` and click on that option.

![IFTTT Choose Webhooks SMS](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-choose-webhooks.png)

On the next screen click on the `Connect` button, then click on the `Receive a web request` box on the following screen.

![IFTTT Receive a web request](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-receive-web-request.png)

You will be prompted for an event name. Enter `button_press` and press the `Create trigger` button.

![IFTTT Create trigger](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-create-trigger.png)

Now click on `+That`. This will take us to the next step of choosing an action service -- in this case we will send an email.

![IFTTT Then That](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-then-that.png)
...
![IFTTT Choose action service](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-choose-action-service.png)
...
![IFTTT Send me an email](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-send-me-an-email.png)
...
![IFTTT Complete action fields](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-complete-action.png)

This will then take you back to the main If Then page. Click on continue

![IFTTT Continue](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-continue.png)
...
![IFTTT Click Webhooks icon](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-click-webhooks-icon.png)
...
![IFTTT Webhooks Key](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/ifttt-webhooks-key.png)
...
![Temperature sensor circuit](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/sensor-circuit.png)
