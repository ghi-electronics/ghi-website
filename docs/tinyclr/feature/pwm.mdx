...
// FEZBit.Timer.Pwm.Controller1 → chip 0
using PwmChannel led = PwmChannel.Create(0, FEZBit.Timer.Pwm.Controller1.Led, 10000, 0.5);
...
|---|---|
| [GHIElectronics.TinyCLR.Devices.Pwm](/docs/tinyclr/api/Devices.Pwm/) | TinyCLR PWM controller and channel classes |
