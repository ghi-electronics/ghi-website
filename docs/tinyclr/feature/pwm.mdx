...
// SC20260.Timer.Pwm.Controller3 → chip 2
using PwmChannel led = PwmChannel.Create(2, SC20260.Timer.Pwm.Controller3.PB0, 10000, 0.5);
...
class Program {
    ...
    private static void Main() {
        ...
        using PwmChannel toneOut = PwmChannel.Create(2, SC20100.Timer.Pwm.Controller3.PB1, NOTE_C, 0.5);
