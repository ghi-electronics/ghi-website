...
The pattern is the same as [virtual displays](graphics.mdx#virtual-displays) — draw into a RAM bitmap, register an `OnFlushEvent` handler, push the bytes to the destination (here: the VNC client).
