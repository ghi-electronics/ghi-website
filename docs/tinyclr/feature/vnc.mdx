...
![TightVNC](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/vnc-client.jpg)

The Preferred encoding format should be set to Raw.

![TightVNC](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/vnc-connection.jpg)

From here, the TinyCLR `Graphics` will appear in the VNC client window. 

![TightVNC](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/vnc-screen.jpg)
...
![TightVNC](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/vnc-debug.jpg)
