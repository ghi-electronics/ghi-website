...
![Adafruit IO Add Certificate](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-add-cert.jpg)
...
![Adafruit create Dashboard](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-create-dashboard.jpg)

Create a meaningful name for our Dashboard. This will be the 'dashboardID' inside our code sample. 

![Adafruit name Dashboard](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-name-dashboard.jpg)

Click on our newly created 'Dashboard'

![Adafruit select Dashboard](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-select-dashboard.jpg)
...
![Adafruit create Block](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-create-block.jpg)
...
![Adafruit select Toggle](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-select-toggle.jpg)
...
![Adafruit name feed](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-name-feed.jpg)

Check the box of the newly created feed and click 'Next Step'

![Adafruit name feed](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-next-step.jpg)
...
![Adafruit block settings](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-block-settings.jpg)
...
![Adafruit create another Blcok](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-add-newblock.jpg)

Let's add a 'Gauge' block to our canvas next. 

![Adafruit create another Blcok](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-add-gauge.jpg)
...
![Adafruit name gauge feed](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-name-gaugefeed.jpg)

There are several setting we can adjust but for this tutorial we'll just us the default and click on 'Create block'

![Adafruit name gauge feed](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-create-gaugeblock.jpg)
...
![Adafruit select key](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-select-key.jpg)

Copy the generated key...

![Adafruit generate key](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-generate-key.jpg)
...
![Adafruit running dashboard](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-complete-dashboard.jpg)

![Adafruit running dashboard](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/adaIO-message-vs.jpg)
