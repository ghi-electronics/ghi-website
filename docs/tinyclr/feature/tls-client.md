...
![Download Root Certificate Step 1](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step1.png)

Select `Certificate (Valid)` option. 

![Download Root Certificate Step 2](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step2.png)

Select the `Certificate Path` TAB and click on the top Root certificate, select the Root Certificate

![Download Root Certificate Step 3](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step3.png)

Next navigate to the `Details` TAB and click on the `Copy to File` button.

![Download Root Certificate Step 4](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step4.png)

The Certificate Export Wizard page will appear, click `Next`

![Download Root Certificate Step 5](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step5.png)

Select the `Base-64 encoded X.509(.CER)` file format and click `Next`

![Download Root Certificate Step 6](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step6.png)

Name the file and browse to the location to save. Then click `Next`

![Download Root Certificate Step 7](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step7.png)

An export confirmation message will appear, click `OK` and then click `Finish`

![Download Root Certificate Step 8](https://docs.ghielectronics.com/software/tinyclr/tutorials/images/tls-step8.png)