...
This tutorial assumes you've finished **[TinyCLR Getting Started](../getting-started.mdx)** — that page installs the tools, flashes firmware, and deploys your first program. Everything here builds on it.
