...
This page assumes you've finished **[TinyCLR Getting Started](../getting-started.mdx)** — that page covers installing the tools, flashing firmware, and deploying your first program, and its VS Code tab walks through the same first project in more detail.
