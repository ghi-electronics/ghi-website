...
![SITCore SC20100S](https://docs.ghielectronics.com/hardware/sitcore/images/system-on-chip.png)

**TinyCLR on a chipset.** Drop a SITCore SoC onto your own PCB and you get the full TinyCLR runtime, real Visual Studio step-debugging, and the complete .NET feature set — at the smallest footprint and lowest unit cost.
...
[![SC13048Q Pinout](https://docs.ghielectronics.com/hardware/sitcore/images/sc13048q-pinout.gif)](https://docs.ghielectronics.com/hardware/sitcore/pdfs/sc13048q-pinout.pdf)

### SC20100S/B Pinout

[![SC20100S Pinout](https://docs.ghielectronics.com/hardware/sitcore/images/sc20100s-b-pinout.gif)](https://docs.ghielectronics.com/hardware/sitcore/pdfs/sc20100s-b-pinout.pdf)

### SC20260B Pinout

[![SC20260B Pinout](https://docs.ghielectronics.com/hardware/sitcore/images/sc20260b-pinout.gif)](https://docs.ghielectronics.com/hardware/sitcore/pdfs/sc20260b-pinout.pdf)
...
The above discussed functions of the LDR, APP, and MOD pins are only available during startup. After startup, the pins return to the default GPIO state and are available as a GPIO (or peripheral pin) in your application. Check out the [Special Pins](/docs/tinyclr/special-pins) page for more information.

---

## TinyCLR OS

TinyCLR OS provides a way to program the SITCore in C# from the Microsoft Visual Studio integrated development environment.  To get started you must first install the firmware on the SITCore (instructions below) and then go to the TinyCLR [Getting Started](/docs/tinyclr/) page for instructions.

### Loading the Firmware

1. Activate the bootloader, hold the LDR signal low while resetting the board.
2. Open [TinyCLR Config](/docs/tinyclr/tinyclr-config) tool.
...
4. Download the [firmware](/docs/tinyclr/downloads). Select the downloaded firmware in TinyCLR Config and click 'Update Firmware'. 

You can also update the firmware manually. Download the [firmware](/docs/tinyclr/downloads) and learn how to use the [GHI Electronics Bootloader](/docs/tinyclr/bootloader) manually

### Start Coding

Now that you have installed the bootloader and firmware on the SITCore, you can setup your host computer and start programming.  Go to the TinyCLR [Getting Started](/docs/tinyclr/) page for instructions.
...
![SC13048Q Footprint](https://docs.ghielectronics.com/hardware/sitcore/images/sc13048q-footprint.gif)

#### This is the recommended footprint for the SC20100S:
![SC20100S Footprint](https://docs.ghielectronics.com/hardware/sitcore/images/sc20100s-footprint.gif)

#### This is the recommended footprint for the SC20100B:
![SC20100B Footprint](https://docs.ghielectronics.com/hardware/sitcore/images/sc20100b-footprint.gif)
![SC20100B Design Rules](https://docs.ghielectronics.com/hardware/sitcore/images/sc20100b-design-rules.gif)

#### This is the recommended footprint and PCB design rules for the SC20260B:
![SC20260B Footprint](https://docs.ghielectronics.com/hardware/sitcore/images/sc20260b-footprint.gif)
![SC20260B Design Rules](https://docs.ghielectronics.com/hardware/sitcore/images/sc20260b-design-rules.gif)
...
For information on these and other important pins, please refer to the [Special Pins](/docs/tinyclr/special-pins) page.
...
[![Reflow Chart](https://docs.ghielectronics.com/hardware/netmf/images/reflow-profile.gif)](http://files.ghielectronics.com/downloads/Documents/Datasheets/WS483%20SAC305%20Solder%20Paste%20Datasheet.pdf)
