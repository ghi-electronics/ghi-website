...
![Bootloader](https://docs.ghielectronics.com/software/tinyclr/images/bootloader.png)
...
Using this tool is the recommended path; however, manual installation instructions are also included on this page. Read more on the [TinyCLR Config](https://docs.ghielectronics.com/../software/tinyclr/tinyclr-config.html) page.
