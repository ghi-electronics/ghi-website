...
- **Visual Studio 2026** (any edition including Community) is the supported IDE for the v3 extension — and v3 also adds **Visual Studio Code** support via a dedicated extension
