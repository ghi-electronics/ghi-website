...
description: TinyCLR v3 is mostly backward-compatible with v2. New features include generics, async/await, C# 11, dual .NET IoT APIs, and RLP for native C/C++ — plus Visual Studio 2026 and VS Code support.
---
