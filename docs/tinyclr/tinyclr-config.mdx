...
:::note
Using Visual Studio? The [Visual Studio Extension](visual-studio-extension.mdx) can detect out-of-date firmware and update it directly from the IDE, so you don't need to run TinyCLR Config separately.
:::
