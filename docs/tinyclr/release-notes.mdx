...
## 3.0.1.6001 (2026-09-01) RTW

A tooling-only release that fixes two deployment failures. Firmware and the libraries are unchanged.

### Visual Studio Extension

- Fixed a deployment failure (`Wrong type in blob` / `MMP0000: 0x81010002`) in projects that enable nullable reference types or use an attribute with a `typeof` argument.

### Visual Studio Code extension

- Includes the same deployment fix as the Visual Studio extension.
...
- No change. 3.0.1.6000 remains the current release.
