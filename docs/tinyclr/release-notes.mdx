...
A Visual Studio extension and `TinyCLR.UI` update with fixes and refinements. Firmware and the other tools are unchanged.
...
- `TinyCLR.UI` updated to support the extension changes in this release.
